...
import RadarKodiClient from "../RADAR-KODI/RadarKodiClient";

export const metadata: Metadata = {
  title: "KODI DOSE+ · Inteligencia de Mercado & Hero SKUs | Apolograma",
  ...
  icons: { icon: "/icon-apolograma.png" },
  openGraph: {
    title: "KODI DOSE+ · Inteligencia de Mercado & Hero SKUs",
    description: "Estudio Estratégico de Mercado y Benchmark de Competidores.",
    images: [{ url: "https://propuestas.tecza.com.mx/assets/og-apolograma.png", width: 1200, height: 630, alt: "KODI DOSE+ Inteligencia de Mercado" }],
  }
};
