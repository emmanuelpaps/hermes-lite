    ...
    <div style={{ background: theme.bgGradient, minHeight: "100vh", fontFamily: "system-ui, -apple-system, sans-serif", color: theme.textMain, overflowX: "hidden" }}>
      ...
      <header style={{ 
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "1.5rem" }}>
          ...
          <img src="/assets/apolograma-logo.png" alt="Apolograma" style={{ height: "45px", opacity: 0.9, filter: "brightness(0) invert(1)" }} />
        </div>
      ...
      <div style={{ maxWidth: "1100px", margin: "0 auto", padding: "0 clamp(1rem, 5vw, 2rem)", position: "relative", zIndex: 10 }}>
        ...
        <footer style={{ 
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "1.5rem", justifyContent: "center" }}>
            ...
            <img src="/assets/apolograma-logo.png" alt="Apolograma" style={{ height: "38px", opacity: 0.5, filter: "brightness(0) invert(1)" }} />
          </div>
